var board = document.getElementsByClassName('board')[0],//игровое поде
 ...
 for (var i = 0; i < 9; i++){
 	...
 	innerElement.setAttribute('y', parseInt(i / 3).toString());//у этой стороки х-номер столбца
...
gamer1 = !gamer1;
player.innerText = gamer1 ? 'Сейчас ходит X' : 'Сечас ходит O';
...
*/
function reset(){
	gamer1 = true;//Показываетб какой мгрок сейчас ходит
	gameTable = [[null,null,null],[null,null,null],[null,null,null]];//Матрица игры
	nullCount = 9;//Количество оставшихся ходов
	winner = null;
