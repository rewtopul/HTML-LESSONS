...
//$('li:odd').css('border', '1px solid red');// Чётные найденые элементы
//$('li:even').css('border', '1px solid red'); // Нечётные найденые элементы
//$('li:gt(0)').css('border', '1px solid red');// Элементы чей порядковый номер больше п
//$('li:lt(3)').css('border', '1px solid red');// Элемента чей порядковый номер меньше п
